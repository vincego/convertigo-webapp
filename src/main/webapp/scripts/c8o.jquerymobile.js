 ...
 *
 * $URL: svn://devus.twinsoft.fr/convertigo/CEMS_opensource/trunk/Studio/tomcat/webapps/convertigo/scripts/7.4.0/c8o.jquerymobile.js $
 * $Author: nicolasa $
 * $Revision: 39935 $
 * $Date: 2015-06-12 09:14:30 +0200 (ven., 12 juin 2015) $
 */
...
$.extend(true, C8O, {
    ...
    _onDocumentReady: function (params) {
        if (!$.mobile.ajaxBlacklist) {
            $("<div id=\"c8oloading\"/>").css({backgroundColor: "white", position: "fixed", width: "100%", height: "100%", opacity: 0, "z-index": 9999999}).hide().appendTo("body");
        }
