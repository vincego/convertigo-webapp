 ...
 *
 * $URL: svn://devus.twinsoft.fr/convertigo/CEMS_opensource/trunk/Studio/tomcat/webapps/convertigo/xsl/pocketpc.xsl $
 * $Author: nicolasa $
 * $Revision: 28824 $
 * $Date: 2011-11-04 11:23:16 +0100 (ven., 04 nov. 2011) $
-->
